...
import com.example.myapp.adpter.ItemAdapter;
import com.example.myapp.models.ItemInfo;
import com.example.myapp.widgt.RefreshListView;
...
public class MyActivity extends Activity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private class DrawerItemClickListener implements ListView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView parent, View view, int position, long id) {
            Toast.makeText(MyActivity.this, ((TextView) view).getText(), Toast.LENGTH_LONG).show();
    ...
    private  void initRefreshLayout()
    {
        ...
        swipeLayout.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                infoList.add(info);
                infoList.add(info);
                adapter = new ItemAdapter(MyActivity.this, infoList);
